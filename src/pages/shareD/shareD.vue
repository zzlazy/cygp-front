      ...
      <div class="weui-form-preview__bd">
        ...
        <div v-for="item in info" v-bind:key="item">
          <div class="weui-form-preview__item">
            ...
            <div class="weui-form-preview__value">{{item.url}}</div>
          </div>
          <div class="weui-form-preview__item">
            <div class="weui-form-preview__label">提取码</div>
            <div class="weui-form-preview__value">{{item.code}}</div>
          </div>
          <div class="weui-form-preview__ft">
            <div @click="open(item)" class="weui-form-preview__btn weui-form-preview__btn_primary" hover-class="weui-form-preview__btn_active">操作</div>
          </div>
        </div>
      </div>
    </div>
